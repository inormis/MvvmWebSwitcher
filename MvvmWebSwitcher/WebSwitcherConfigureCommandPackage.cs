...
namespace MvvmWebSwitcher {
    ...
    public sealed class WebSwitcherConfigureCommandPackage : Package {
        /// <summary>
        ///     WebSwitcherConfigureCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "3fc2793e-5e40-4e04-8797-de79199b1e48";
        ...
        protected override void Initialize() {
            MvvmWebSwitcherConfigureCommand.Initialize(this);
            base.Initialize();
        }
